// I learned this shader from Jonathan's site:  
// https://afternoon-citadel-39704.herokuapp.com/projects/10
// Thanks for his amazing work
// To know more about this topic, you might visted this site:
...
vec3 calculateBlinnPhong(vec3 diffColor, vec3 p, vec3 rayDir) 
{
    ...
    vec3 eyeVec = normalize(u_CameraPos - p);
